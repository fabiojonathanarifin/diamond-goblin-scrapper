...
async function cryptopriceScraper() {
  ...
  await axios(url).then((response) => {
    ...
    const selectedElem =
      "#__next > div.sc-c5c9d167-1.iZIMUr > div.main-content > div.sc-1a736df3-0.PimrZ.cmc-body-wrapper > div > div:nth-child(1) > div.sc-f7a61dda-2.efhsPu > table > tbody > tr:nth-child(5)";
    const keys = [
      "No.",
      "Coin",
      "Price",
